...
local t = Def.ActorFrame {
	...
	LoadFont( "Combo", "numbers" ) .. {
		Name="Number";
		OnCommand = THEME:GetMetric("Combo", "NumberOnCommand"); -- y,240-216-4;x,24,shadowlength,1;halign,1;valign,1;skewx,-0.125;zoom,0.5;
	};
	LoadFont("Common Normal") .. {
		Name="Label";
		OnCommand = THEME:GetMetric("Combo", "LabelOnCommand"); -- x,30;y,20;shadowlength,1;zoom,0.75;diffusebottomedge,color("0.75,0.75,0.75,1");halign,0;valign,1
	};

	LoadFont("Common Normal") .. {
		Name="GhostScore";
		OnCommand = function(self)
			self:xy(48,0):zoom(0.5):halign(0):valign(1):shadowlength(1)
	...
	TwentyFiveMilestoneCommand=function(self,parent)
		(cmd(skewy,0;decelerate,0;skewy,0))(self);
	end;
