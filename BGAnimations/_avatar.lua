...
t[#t+1] = Def.ActorFrame{
	...
	LoadFont("Common Normal") .. {
		InitCommand=cmd(xy,AvatarXP1+53,AvatarYP1+7;halign,0;zoom,0.6;diffuse,getMainColor('positive'));
		BeginCommand=cmd(queuecommand,"Set");
		SetCommand=function(self)
	...
	LoadFont("Common Normal") .. {
		InitCommand=cmd(xy,AvatarXP1+53,AvatarYP1+20;halign,0;zoom,0.35;diffuse,getMainColor('positive'));
		BeginCommand=cmd(queuecommand,"Set");
		SetCommand=function(self)
	...
	LoadFont("Common Normal") .. {
		InitCommand=cmd(xy,AvatarXP1+53,AvatarYP1+30;halign,0;zoom,0.35;diffuse,getMainColor('positive'));
		BeginCommand=cmd(queuecommand,"Set");
		SetCommand=function(self)
	...
	LoadFont("Common Normal") .. {
		InitCommand=cmd(xy,AvatarXP1+53,AvatarYP1+40;halign,0;zoom,0.35;diffuse,getMainColor('positive'));
		BeginCommand=cmd(queuecommand,"Set");
		SetCommand=function(self)
